...
function Menubar({
  ...
  return (
    <MenubarPrimitive
      data-slot="menubar"
      className={cn("flex h-8 items-center gap-0.5 rounded-lg  p-[3px]", className)}
      {...props} />
  );
}
...
function MenubarTrigger({
  ...
  return (
    <DropdownMenuTrigger
      ...
      className={cn(
        "flex items-center rounded-sm px-1.5 py-[2px] text-sm font-medium outline-hidden select-none aria-expanded:bg-muted",
        className
      )}
      {...props} />
  );
