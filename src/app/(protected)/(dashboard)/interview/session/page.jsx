...
export default function VoiceVADComponent() {
  ...
  // socketRef.current.emit("success", "success mic enabled")
  ...
  useEffect(() => {
   ...
   socketRef.current.on("disconnect",(reason) => {
    ...
    // 6. Complete cleanup routine safely tracking component unmount hooks
    return () => {
  ...
  }, []); // Keeps listeners locked down on component mount only
